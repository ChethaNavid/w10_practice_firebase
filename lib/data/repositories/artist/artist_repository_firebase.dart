...
import 'package:w10_practice_firebase/data/dtos/song_dto.dart';
...
class ArtistRepositoryFirebase implements ArtistRepository {
  ...
  Future<List<Artist>> fetchArtists() async {
    ...
    if (response.statusCode == 200) {
      ...
      final Map<String, dynamic> artistsJson = decodedBody as Map<String, dynamic>;
  ...
  Future<Artist?> fetchArtistById(String id) async {
    ...
    if (response.statusCode == 200) {
      ...
      final Map<String, dynamic> artistJson = decodedBody as Map<String, dynamic>;
  ...
  Future<List<Comment>> fetchCommentByArtist(String artistId) async {
    ...
    if (response.statusCode == 200) {
      ...
      final Map<String, dynamic> commentsMap = decodedBody as Map<String, dynamic>;
